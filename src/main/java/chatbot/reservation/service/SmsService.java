...
public class SmsService {
    ...
    public JSONObject makeHttpBodyData(ReservationInfoDTO reservation, MemberDTO member){
        ...
        toJson.put("to", member.getMobile());   // 수신번호 목록  * 최대 50개까지 한번에 전송할 수 있습니다.
        toArr.add(toJson);
...
//            logger.info("request url : {}", url);
            ...
            dataOutputStream.write(makeHttpBodyData(reservation, member)
                    .toJSONString()
                    .getBytes());
